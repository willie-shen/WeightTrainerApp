...
class PlanViewController: UITableViewController {
    ...
    //Use this for the cells, and also to send to next view controller
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        //Reference for using a table cell as a segue
        if segue.identifier == "showWorkouts", let showPlansViewController = segue.destination as? ShowPlansViewController, let partIndex = tableView.indexPathForSelectedRow?.row{
            
            showPlansViewController.workoutType = parts[partIndex]
            showPlansViewController.title = parts[partIndex]
